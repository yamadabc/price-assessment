...
class CSVController extends Controller
{
    ...
    {   
        $request->validate([
            'csv' => 'required|file|mimes:csv,txt|mimetypes:text/plain',
        ]);
        ...
        foreach($file as $row)
        {
            ...
            if($row_count > 1)//ヘッダーは取り込まない
            {
                 ...
                 $csvimport_array = [
                     ...
                     'roof_balcony_area'         => $balcony_area,
                     'terass_area'               => $balcony_area,
                     'garden_area'               => $balcony_area,
                     'residential_building_name' => $balcony_area,
                     'layout_type'               => $layout_type,
                     'published_price'           => $published_price,
                     'expected_price'            => $published_price,
                     'expected_rent_price'       => $published_price,
                     'created_at'                => $created_at,
                     'updated_at'                => $updated_at,
                 ];
                 array_push($array, $csvimport_array);
