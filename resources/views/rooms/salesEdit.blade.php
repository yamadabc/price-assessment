...
<table class='table table-striped table-bordered table-sm'>
    ...
    @elseif(!empty($room) && !empty($soldSalesRoom) && empty($stockSalesRoom))
        {!! Form::model($room,['route' => ['sales_update',$room->id,-1,$soldSalesRoom->id],'method' => 'PUT']) !!}
    ...
    <tr>
        ...
        <div class="form-group">
            @if(isset($stockSalesRoom))
                <td>{!! Form::date('registered_at',old('registered_at',$stockSalesRoom->registered_at),['class' => 'form-control']) !!}</a></td>
            @else
        ...
        <div class="form-group">
            @if(isset($stockSalesRoom))
                <td>{!! Form::date('changed_at',old('changed_at',$stockSalesRoom->changed_at),['class' => 'form-control']) !!}</a></td>
            @else
        ...
        <div class="form-group">
            @if(isset($soldSalesRoom))
                <td>{!! Form::date('sold_registered_at',old('sold_registered_at',$soldSalesRoom->registered_at),['class' => 'form-control']) !!}</a></td>
            @else
        ...
        <div class="form-group">
            @if(isset($soldSalesRoom))
                <td>{!! Form::date('sold_changed_at',old('sold_changed_at',$soldSalesRoom->changed_at),['class' => 'form-control']) !!}</a></td>
            @else
